...
void PWM_motor_control(int PWM_pinChoice){
  ...
  switch (PWM_pinChoice) {
    ...
    case 30:
      ...
      if(TCC0->SYNCBUSY.bit.CC3 == 1){Serial.println("I'm busy");}
      while (TCC0->SYNCBUSY.bit.CC3);   //Not sure if that does something. There is no SNCBUSY for CCBUF
      if(TCC0->SYNCBUSY.bit.CC3 == 0){Serial.println("I'm no longer busy");}
      break;
    ...
    case 31:
      ...
      while (TCC0->SYNCBUSY.bit.CC2);   //Not sure if that does something
      break;
    ...
    case 32:
      ...
      while (TCC0->SYNCBUSY.bit.CC1);   //Not sure if that does something
      break;
    ...
    case 33:
      ...
      while (TCC0->SYNCBUSY.bit.CC0);   //Not sure if that does something
      break;
