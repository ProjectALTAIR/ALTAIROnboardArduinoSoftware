...
class     ALTAIR_TelemetrySystem {
  public:
    ...
    byte*                    readPrimary(    ) { return       _primaryRadio->readALTAIRCommand() ; }
    byte*                    readBackup1(    ) { return   _firstBackupRadio->readALTAIRCommand() ; }
    byte*                    readBackup2(    ) { return  _secondBackupRadio->readALTAIRCommand() ; }
